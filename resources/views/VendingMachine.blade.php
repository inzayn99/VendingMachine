    ...
    <div class="row">
        ...
        <div class="col-md-4" style="margin-left: 100px">
            <form action="{{action('VendingMachineController@insertMoney')}}" method="POST">
                {{csrf_field()}}    <span style="display: block;
                 text-align: center"><b>Balance</b></span>
                <span style="display:block;
                 color: #a8fab0;
                 font-size: 25px;
                  font-weight: bold;
                   text-align: center">${{$vendingMachine['inserted_money']}}</span>
            ...
            <form action="{{action('VendingMachineController@selectSnack')}}" method="POST">
                ...
                <div style="width:200px;
                 margin: auto ;border: 1px solid gray;
                  background-color: rgba(141,234,138,0.62);
